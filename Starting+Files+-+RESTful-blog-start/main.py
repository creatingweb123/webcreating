...
def edit_post(post_id):
    ...
    return render_template("make-post.html",form=editform,img_url=url_for('static', filename='img/edit-bg.jpg'))
...
def new_post():
    ...
    if postform.validate_on_submit():
        post = BlogPost(
            ...
            subtitle=postform.subtitle.data,
            date    =today.strftime("%B %d,%Y"),
            body    =postform.body.data,
            author  =postform.author.data,
            img_url =postform.img_url.data
        )
        db.session.add(post)
        db.session.commit()
        return redirect(url_for('get_all_posts'))

    return render_template("make-post.html",form=postform,img_url=url_for('static', filename='img/edit-bg.jpg'))
